  ...
  },
  {
    ...
    tutorials: [
      ...
      },
      {
        ...
        goal: 'Connect hardware GPS or use device GPS fallback',
        duration: '~3 minutes',
        ...
        steps: [
          ...
          { action: 'Device GPS Fallback (No Hardware)', details: 'If no hardware GPS, app auto-switches to device GPS. Click "Allow" in location prompt.', expected: 'GPS source shows "Browser Geolocation", coordinates appear', narration: 'No GPS hardware? No problem - device GPS works as a backup' },
        ...
        tips: ['Hardware GPS is more accurate than device geolocation', 'Wait 30-60 seconds for GPS fix when first connecting', '3D Fix is ideal (10+ satellites)'],
      },
      {
        id: 'setup-camera',
        number: '2.3',
