...
export const POI_TYPES: POITypeConfig[] = [
  ...
  { type: 'gradeUp', label: 'Grade UP (legacy)', color: 'text-lime-400', bgColor: 'bg-lime-400/20', icon: TrendingUp },
  { type: 'gradeDown', label: 'Grade Down (legacy)', color: 'text-orange-500', bgColor: 'bg-orange-500/20', icon: TrendingDown },
