...
const CURRENT_CACHE_VERSION = '16.1.101';
...
if (!libraryHealth.healthy) {
  ...
  if (root) {
    try {
      ...
      const LicenseInfoModal = React.lazy(() => import('./components/LicenseInfoModal'));
            ...
            <React.Suspense fallback={<div className="h-screen flex items-center justify-center bg-gray-950 text-gray-500">Loading...</div>}>
              <LicenseGate>
                <QueryClientProvider client={queryClient}>
                  <AuthProvider>
                    <App />
                    <React.Suspense fallback={null}><LicenseInfoModal /></React.Suspense>
                  </AuthProvider>
                </QueryClientProvider>
              </LicenseGate>
            </React.Suspense>
